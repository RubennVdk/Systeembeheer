...
if [ -n "$1" ]; then
	...
	#by using a template and sed, we can create new zones easily
	#first we add the new zone in the placeholder and then place that text into our master zone file
